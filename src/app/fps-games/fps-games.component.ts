...
export class FpsGamesComponent implements OnInit {
  ...
  fps=[
    ...
    {'id':5,'name':'Doom Eternal','description':"Doom Eternal is a first-person shooter game developed by id Software and published by Bethesda Softworks. Set some time after the events of the 2016 game, the story follows the Doomguy once again, on a mission to end Hells consumption of Earth and foil the alien Maykr's plans to exterminate humanity.",'image':'../../assets/doom.jpg'},
